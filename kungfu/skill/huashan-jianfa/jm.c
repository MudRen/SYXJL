...
{       
        ...
        if( (int)me->query_skill("huashan-jianfa", 1) < 90 ||
...
int perform2(object me)
{
        ...
        if (me->query("combat_exp")> target->query("combat_exp")/3 )
        {
                ...
                damage = (int)me->query_skill("zixia-gong", 1) +damage;
                ...
                if(  (int)me->query_skill("huashan-jianfa", 1) > 135
...
{     
      skill = (int)me->query_skill("huashan-jianfa", 1)/10;                
      me->add_temp("apply/attack", -skill);
      me->add_temp("apply/dodge",  -skill);
      me->add_temp("apply/parry",  -skill);  
