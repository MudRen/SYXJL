...
正是嵩山剑法的精要所在，一招‘"+HIY"千古人龙"NOR+"’向$n$l直刺过来",
        "dodge":   -70,
        "damage":  120,
        "damage_type":  "刺伤"
]),
...
([      "name":    "开门见山",
        "action":  "$N左手向外一分，右手$w向右掠出，使的是嵩山派剑法‘"+MAG"开门见山"+NOR"’",
        "dodge":   -70,
        "damage":  120,
        "damage_type":  "刺伤"
]),
([      "name":    "独劈华山",
        "action":  "$N手中$w自上而下的向$n直劈下去，一招‘"+CYN"独劈华山"+NOR"’，真有石
...
宗剑法‘"+HIW"天外玉龙"NOR+"’。但见$w自半空中横过，剑身似曲似直，长
剑便如一件活物一般",
        "dodge":   -40,
        "damage":  140,
        "damage_type":  "刺伤"
