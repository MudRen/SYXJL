...
{
    if (random(me->query_skill("sword",1)) > 150 &&
        me->query_skill("jiuyang-force",1) > 150 &&
        me->query("neili") > 800 &&
...
int valid_learn(object me)
{
        ...
        if ((int)me->query_skill("jiuyang-force", 1) < 100)
                return notify_fail("你的九阳真气火候还不够，学不了圣火令法！\n");
