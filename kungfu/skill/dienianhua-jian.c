...
mapping *action = ({
	...
	([	
		...
		"action":		"$N使一招「宁倚危阑风细细」，身形轻摇，手中$w一摆，向$n的
...
$l刺去",
	...
	([	
		...
		"action":		"$N身形拔地而起，手中$w舞动，满天剑气森森，一招「草色烟光残照里」
...
罩向$n的$l",
	...
	([	
		...
		"action":		"$N手中$w光芒闪闪，一招「无言谁会凭阑意」，瞬间已向$n的
...
$l连攻数剑",
	...
	([	
		...
		"action":		"$N手中$w一圈，带起满天沙尘，突然剑身一颤，化出无数剑尖，一招
...
「拟把疏狂图一醉」笼住$n的$l",
	...
	([	
		...
		"action":		"$N$w闪动，幻出满天剑影，团团簇簇，一招「衣带渐宽终不悔」往
...
$n$l刺去",
	...
	([	
		...
		"action":		"$N身行跃起，手中$w挽出朵朵剑花，一招「为伊消得人憔悴」裹住
...
/*
       if( (string)me->query("gender") != "女性" )
                ...
                return notify_fail("蝶念花剑法是只有女性才能练的武功。\n");
...

{
	...
	if ((int)me->query("qi") < 50)
		...
		return notify_fail("你的体力不够练蝶念花剑法。\n");
