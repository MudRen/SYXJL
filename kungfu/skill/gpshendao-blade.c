...
([
"action" :"$N前腿踢出，后腿脚尖点地，一式「大放狗屁」二掌直出，攻向$n的上中下三路$N纵身一跃，手中$w一招「大臭屁」对准$n的$l斜斜砍出一刀",
"force" :50,
"dodge" :20,
"damage_type": "割伤",
"lvl" : 0,
...
object weapon; if (!objectp(weapon = me->query_temp("weapon"))
	...
	if( (int)me->query("max_neili") < 50 )
		return notify_fail("你的内力太弱，无法练"+"狗屁神刀"+"。\n");
	return 1;
}
...
{
        int i, level;
    level = (int)me->query_skill("gpshendao-blade",1);
