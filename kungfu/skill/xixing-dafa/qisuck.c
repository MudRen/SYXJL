...

{
	...
	if( objectp(me->query_temp("weapon")) )
		...
		return notify_fail("你必须空手才能施用吸星大法吸人真气！\n");
...
//        if( !me->is_fighting() || !target->is_fighting())
	...
	if( (int)me->query_skill("xixing-dafa",1) < 30 )

		return notify_fail("你的吸星大法功力不够，不能吸取对方的真气。\n");
	...
	message_vision(
        ...
        sp = me->query_skill("force") + me->query_skill("dodge") + me->query_skill("xixing-dafa",1)/2;
...

	{
		...
		target->receive_damage("qi", (int)me->query_skill("xixing-dafa", 1) );

		me->add("qi", (int)me->query_skill("xixing-dafa", 1) );

		me->add("eff_qi", (int)(me->query_skill("xixing-dafa", 1)*2/3) );
