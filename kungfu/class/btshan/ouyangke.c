...

{
  ...
  this_object()->carry_object("/d/baituo/obj/baipao")->wear();
	...
	if( interactive(ob = this_player()) && !is_fighting() ) 

       {
		...
		call_out("greeting", 1, ob);
          ...
          if((int)ob->query("shen")>=0&&ob->query("family/master_id")=="ouyang ke")
        {
