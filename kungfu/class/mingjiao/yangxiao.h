...

{
	...
	fighter->set_temp("xuanku-asked", 1);
        ...
        say("\n杨逍说道：好吧，我来召集罗汉堂长老们于东练武场集合，我稍候在中央练武场上等你。\n");
	...
	if( !fighter->query_temp("xuannan-asked") )
        ...
        say("\n杨逍又道：请你速去告知般若堂范右使，请他即刻招集般若堂诸罗汉于西练武场集合。\n");
...

	{
...

		{
	        	...
	        	me->move("/d/shaolin/luohan5");
                        ...
                        return "真是对不起，罗汉堂中有人不在，无法举行光明圣火阵。\n";
...

{
	...
	monk = present("daojue chanshi", room);
        ...
        message("vision", "杨逍跟道觉禅师俯耳轻声说了几句。\n", room, monk );
