...
//        string *skname;
        ...
        // If the target is willing to recruit us already, we do it.
                ...
                if( (string)me->query("family/family_name")=="镇南王府" && (string)ob->query("family/family_name")=="天龙寺" ) 
                                me->set("family/family_name","天龙寺");

                if( (string)me->query("family/family_name")=="天龙寺" && (string)ob->query("family/family_name")=="镇南王府" ) 
                                me->set("family/family_name","镇南王府");
...

        {
...

                {
                        ...
                        temp = read_file("/log/static/FENG", 1, 1);
                        ...
                        write_file("/log/static/FENG", temp, 1);
