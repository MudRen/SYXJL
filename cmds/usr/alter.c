...
int main(object me, string arg)
{
        ...
        switch(verb) {
                case "desc":
                        if(!CHINESE_D->check_chinese(replace)) return notify_fail("描述必须是中文A。\n");
                ...
                case "wield_msg" :
                        ...
                        if(!CHINESE_D->check_chinese(tmp)) return notify_fail("描述必须是中文B。\n");             
                ...
                case "unwield_msg" :
                        ...
                        tmp = replace_string(replace,"$N","");
                        tmp = replace_string(tmp,"$n", "");
                        if(!CHINESE_D->check_chinese(tmp)) return notify_fail("描述必须是中文C。\n");
                ...
                case "wear_msg" :
                        ...
                        tmp = replace_string(replace,"$N","");
                        tmp = replace_string(tmp,"$n", "");
                        if(!CHINESE_D->check_chinese(tmp)) return notify_fail("描述必须是中文D。\n");
                ...
                case "remove_msg" :
                        ...
                        tmp = replace_string(replace,"$N","");
                        tmp = replace_string(tmp,"$n", "");
                        if(!CHINESE_D->check_chinese(tmp)) return notify_fail("描述必须是中文E。\n");
