...
//        message_vision(HIM "\n$N多么思念妻子"+me->query("couple/couple_name")+"啊...\n"NOR, me);
 ...
 tell_object(obj,sprintf(HIM"你的"+obj->query("couple/couple_gender")+"在思念你... ...\n" NOR));
       ...
       write(HIM "你多想拥抱你的" + me->query("couple/couple_gender") + "深深地一吻...\n" NOR);

	  tell_object(obj, sprintf( HIM "你的%s多想拥抱你，给你深深的一吻... ...\n" NOR,
	  ...
	  write(HIM "你悄悄告诉你的" + me->query("couple/couple_gender") + "：" + arg + "\n" NOR);
