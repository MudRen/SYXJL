...
int perform(object me, object target)
{
        ...
        pfm_time=(int)busy_time-(me->query("juehu-shou",1)+me->query("taiji-shengong",1))*(1+busy_time)/200*busy_time;
        pfm_time1=busy_time1+(int)(me->query("juehu-shou",1)+me->query("taiji-shengong",1))*(1+busy_time)/200*busy_time;
        ...
        } else 
        {
                ...
                l_temp=80-(int)me->query_skill("taiji-shengong", 1)/10;
                me->add("neili", -l_temp);
