...
void create()
{
        ...
        if( clonep() )
                ...
                set("unit", "张");
                set("long",
"这是一张"HIR"圣诞贺卡"NOR"，送给每位在圣诞节进入"HIC"随缘鹿鼎记"NOR"
的玩家。你可以打开(dakai)来看看，用(chaikai)来看
看您得到了什么好东东 :)\n");
                set("value", 0);
                set_weight(10);
        }
...
一个礼品盒！\n", me);
                ...
                if (random(4) == 1)
                {
                        obj0 = new("/d/quanzhen/obj/qixingjian");
                        obj0->move(box);
                }
                if (random(5) == 1)
                {
                        obj5 = new("/d/honghua/xuelian");
                        obj5->move(box);
                }
                if (random(3) == 1)
                {
                        obj6 = new("/d/shenlong/obj/baihua");
                        obj6->move(box);
                }
                if (random(4) == 1)
                {
                ...
                if (random(3) == 1)
                {
                        obj2 = new("/u/bsd/tenthousand-cash");
                        obj2->move(box);
                }
                if (random(2) == 1)
                {
