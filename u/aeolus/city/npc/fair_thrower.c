...

{
        ...
        switch( random(7) ) {
                ...
                case 0:
                        ...
                        say( "»ª×ÐÐ¦ßäßäµØËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                ...
                case 1:
                        ...
                        say( "»ª×Ð»ÎÁË»ÎÊÖÖÐµÄ÷»×Ó£¬½ÐµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                ...
                case 2:
                        ...
                        say( "»ª×ÐËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
...

{
	...
	tell_object(who,"»ª×ÐÇÄÇÄ¸æËßÄã£ºÏÂÊÖ¶ùÑ¹"+message+"£¬Ò»¶¨Ó®£¡\n");
	...
	message_vision("$N»áÐÄµÄÎ¢Ð¦ÆðÀ´£®£®\n",who);
                    ...
                    say("»ª×ÐËµµÀ£ºÕâµãÇ®Äã»¹ÊÇ×Ô¼ºÓÃ°É£¡\n");
