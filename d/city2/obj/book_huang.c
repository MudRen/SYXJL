...
void create()
{
        set_name(HIY"『四十二章经』"NOR, ({"book_huang"}));
        set_weight(1000);
        if( clonep() )
...
int do_tear(string arg)
{
        ...
        if( dir=="binding" ) {
                ...
                message("shout", HIR "【江湖传闻】" + HIM + "某人: 据说"  +this_player()->query("name") + "于" + NATURE_D->game_time() + "得到正黄旗
          "HIY"『四十二章经』"HIM"内的几块破羊皮。共得到"HIW"" + chinese_number(i) + ""HIM"点经验，"HIW"" + chinese_number(j) + ""HIM"点潜能。\n\n" NOR,users()); 
