...
void create()
{
        set_name("赵志敬", ({"master zhao","zhao zhijing", "zhao", "zhijing"}));
        set("master", "王处一");
        set("gender", "男性");
        set("age", 30);
        set("long",
...
void init()
{
        ...
        ::init();
        ob = this_player();
        if((int)ob->query("shen")<=-100&&ob->query("family/master_id")=="master zhao")
       {
