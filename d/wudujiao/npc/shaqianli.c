...
&&ob->query_temp("wudu_xs/yaoshi")))
        ...
        sil=(int)(ob->query_skill("force",1)/10)+random(5);
             pot=ob->query("max_pot",1)/6+random(12);;
             sco=ob->query("max_pot",1)/10+random(5);;
            exp=random(30)+ob->query("max_pot")/5;;
