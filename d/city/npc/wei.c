...
//	set("nickname", "Â¹¶¦¹«");
 ...
 this_player()->carry_object("/d/city/obj/flower_shoe")->wear();


 this_player()->carry_object("/d/city/obj/pink_cloth")->wear();
// this_player()->carry_object("/u/rhxlwd/xueyuetu")->wear();
}
