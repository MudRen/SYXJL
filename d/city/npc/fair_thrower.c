...
//        int i,amun;
        set_name( "»ª×Ğ", ({ "hua zi", "hua" }) );

	set("title", HIW "¶ÄÏÀ" NOR);
...

{
        ...
        switch( random(7) ) {
                ...
                case 0:
                        ...
                        say( "»ª×ĞĞ¦ßäßäµØËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                ...
                case 1:
                        ...
                        say( "»ª×Ğ»ÎÁË»ÎÊÖÖĞµÄ÷»×Ó£¬½ĞµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                ...
                case 2:
                        ...
                        say( "»ª×ĞËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
...

{
	...
	tell_object(who,"»ª×ĞÇÄÇÄ¸æËßÄã£ºÏÂÊÖ¶ùÑ¹"+message+"£¬Ò»¶¨Ó®£¡\n");
	...
	message_vision("$N»áĞÄµÄÎ¢Ğ¦ÆğÀ´£®£®\n",who);
                    ...
                    say("»ª×ĞËµµÀ£ºÕâµãÇ®Äã»¹ÊÇ×Ô¼ºÓÃ°É£¡\n");
