...

{
        ...
        set_name( "ĞÇ¸ç", ({ "xing ge", "xing" }) );

	set("title", HIW "¶ÄÊ¥" NOR);
...

{
        ...
        switch( random(7) ) {
                ...
                case 0:
                        ...
                        say( "ĞÇ¸çĞ¦ßäßäµØËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                ...
                case 1:
                        ...
                        say( "ĞÇ¸ç»ÎÁË»ÎÊÖÖĞµÄ÷»×Ó£¬½ĞµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
                ...
                case 2:
                        ...
                        say( "ĞÇ¸çËµµÀ£ºÕâÎ»" + RANK_D->query_respect(ob)
...

{
	...
	if(!arg || !sscanf(arg, "%d %d",bet_type,bet_amt))
                ...
                return notify_fail("bet <ÖÖÀà> <ÒøÁ¿>\n");
...

{
	...
	tell_object(who,"ĞÇ¸çÇÄÇÄ¸æËßÄã£ºÏÂÊÖ¶ùÑ¹"+message+"£¬Ò»¶¨Ó®£¡\n");
	...
	message_vision("$N»áĞÄµÄÎ¢Ğ¦ÆğÀ´£®£®\n",who);
                    ...
                    say("ĞÇ¸çËµµÀ£ºÕâµãÇ®Äã»¹ÊÇ×Ô¼ºÓÃ°É£¡\n");
...
int do_convert(string arg)
{
	...
	if ( me->over_encumbranced() )
		return notify_fail("Äã´ø²»ÁËÕâÃ´¶àÇ®£¬ÉÙ»»µã°É¡£\n");
