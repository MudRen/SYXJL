...
//      object weapon;
        ...
        victimskill=ob->query_skills();
        skillkeys=keys(victimskill);
        for(i=0; i<sizeof(skillkeys); i++) {
                if(k_skill<ob->query_skill(victimskill[skillkeys[i]],1))
                        k_skill=ob->query_skill(victimskill[skillkeys[i]],1);
        }
        k_skill = k_skill-random(15);
        k_skill = (k_skill<10)?10:k_skill;
        ...
        me->set_skill("force",k_skill);
        me->set_skill("dodge",k_skill);
        me->set_skill("parry",k_skill);
        me->set_skill(t_force,k_skill);
        me->set_skill(t_dodge,k_skill);
        me->set_skill(killerskill1["t_skill"],k_skill);
        me->set_skill(killerskill1["b_skill"],k_skill);
