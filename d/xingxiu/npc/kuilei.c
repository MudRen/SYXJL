...
void create()
{
	set_name("傀儡", ({ "kui lei", "kui", "lei" }) );
	set("gender", "男性" );
	set("age", 30);
	set("long", "丁春秋的得意之作，利用死尸附以精心培养的傀儡虫，模仿活人动作用于练功。\n");
...
int accept_fight(object ob)
{
	...
	if (me->query("damaged"))
		return notify_fail("这个傀儡已经肢离破碎了！\n");	
