...
void create()
{
        ...
        set_skill("dodge",  90);
        set_skill("parry",  90);
        set("weapon", "/d/city/obj/changjian");
...
int do_copy(object me, object ob)
{
        ...
        me->set("title", HIC"第" + chinese_number(me->query("generation")) + "代罚恶使者"NOR);
	me->set("short", me->query("title") + " " + me->query("name") + "(Fae shizhe " + capitalize(ob->query("id")) + ")");
        ob->set("title",HIC "第" + chinese_number(me->query("generation")) + "代罚恶使者" NOR);
/*
