...
int accept_kill(object ob)
{
        ...
        {
            message_vision("$N扑上去想拆掉$n，结果$n“蓬蓬”几下就把$N撩倒在地。\n",
                           ob, me);
            ob->start_busy(3);
            return notify_fail("这个练功的" + name() + "太强了，你拆不掉它。\n");
        }
