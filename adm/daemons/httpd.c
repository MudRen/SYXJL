...
/* Modify to ES2 mudlib base by xiaobao@XAJH
 * Ported to Mud XAJH by ken@XAJH
 * [98-9-21] Because the XAJH mudlib upgrade to under MudOS v22.1b20
 *           the 'static' value modify to 'nosave'
 *           the 'static' function modify to 'protected'
 *           add inherit F_DBASE by ken@XAJH for system channel message.
 */
...
#define DEFAULT_HEADER "Server: "+"XAJH"+"/0.2\nMIME-version: 1.0%c"
...
void remove()
{
	CHANNEL_D->do_channel(this_object(), "sys", "网页服务器已经终止.");
	socket_close(httpSock);
}
