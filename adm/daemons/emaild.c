...
inherit F_DBASE;
//建立连接使用的socket号和发送标志
int my_socket,status=0,scount=0;
//缺省的发送邮件服务器地址
mapping d_smtp=([
        "ip":"202.98.116.150",
        "port":"25",
        "name":"sc.homeway.com.cn",
	]);
//正式使用的发送邮件服务器地址
mapping smtp;
//邮件的收件人，发件人，主题和信息！
string rcpt_to,mail_from,subject,msg,en;
...
void send_email()
{
	...
	ATTACH="\n\n" +
		"【"+CHINESE_MUD_NAME+"163地址：202.98.116.150 6666\n"+
		"【"+CHINESE_MUD_NAME+"169地址：10.143.29.49 6666\n"+		
	...
	msg=email["msg"];
	msg="FROM:"+CHINESE_MUD_NAME+"<jzbyt@sina.com>\n"+
		"TO:"+rcpt_to+"\n"+
